...
object StreamingExample {
    ...
    def main(args: Array[String]) {
        ...
        val userRelationLines = ssc.socketTextStream("kenai", 11711)
        ...
        val userHashtagLines = ssc.socketTextStream("kenai", 11712)
        ...
        val userDataLines = ssc.socketTextStream("kenai", 11713)
